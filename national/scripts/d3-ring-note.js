d3.ringNote = function() {
  ...
  function draw(selection, annotation) {
    ...
    var circle = gAnnotation.append("circle")
      .attr("class", "annoteCircle")
      .attr("r", function(d) { return d.r; });
    
    var line = gAnnotation.append("path")
      .attr("class", "annotePath")
      .call(updateLine);
      
    var text = gAnnotation.append("foreignObject")
//      .append("text")
      .call(updateText, true);
...
//      console.log(path(lineData));
  ...
  function updateText(selection, firstTime) {
...
//      console.log(d);
      ...
      d3.select(this)
        ...
        .attr("width", function(d) {
          if (d.key == "Yangon") return 1100; 
          else if (d.key == "Mandalay") return 700;
          else return 400;
        })
        .each(function(d) {
          var x = d.textOffset[0],
...
//            .call(wrapText, d.textWidth || 960, orientation);
      ...
      if (firstTime) {
        d3.select(this)
          .append("xhtml:div")
          .attr("class","annoteText")
//          .html("<table><tr><td>Aaaaa</td><td>Bbbbb</td></tr><tr><td>Aaaaa</td><td>"+d.text+"<td></tr></table>");
          .html(d.text);
      } else {
        d3.select(this)
          .selectAll(".annoteText")
//          .html("<table><tr><td>Aaaaa</td><td>Bbbbb</td></tr><tr><td>Aaaaa</td><td>"+d.text+"<td></tr></table>");
          .html(d.text);
      }
